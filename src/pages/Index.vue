<template>
  <q-page class="flex flex-center">
    ...
    >
      <img
        src="../assets/prof-cropped.jpeg"
        class="profile-picture q-mb-xl"
        alt="A picture of Dylan's face smiling."
      />
      <p class="text-h2 text-white text-weight-bolder">DYLAN ATTAL</p>
